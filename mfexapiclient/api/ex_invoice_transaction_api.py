...
class ExInvoiceTransactionApi(object):
    ...
    def find_office_ex_invoice_transactions_with_http_info(self, office_id, **kwargs):  # noqa: E501
        ...
        all_params = ['office_id', 'page', 'query_object_ex_destination_id', 'query_object_number', 'query_object_number_from', 'query_object_number_to', 'query_object_dept_id', 'query_object_project_code_id', 'query_object_ex_item_id', 'query_object_office_member_id', 'query_object_approved_at_from', 'query_object_approved_at_to', 'query_object_book_date_from', 'query_object_book_date_to', 'query_object_updated_at_from', 'query_object_updated_at_to', 'query_object_approval_status', 'query_object_order_by_option']  # noqa: E501
